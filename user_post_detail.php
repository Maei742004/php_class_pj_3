      ...
      <h4 class="comments-count">
       ...
       <div class="reply-form">
        ...
        <form action="">
         ...
         <div class="row">
          <div class="col form-group">
           <textarea id="comments"name="comment" class="form-control" placeholder="Your Comment*"></textarea>
          </div>
         </div>
         <div class="md-3">
  ...
  // include("config/db_con.php");
   ...
   ?>
         <div class="post-item mt-3">
          ...
          <div>
           <h4><a href="recent_post_detail.php?id=<?= $row['id'] ?>"><?= substr($row['title'], 0, 20) ?></a></h4>
